...
form.addEventListener("submit", async (e)=>{
  ...
  try{
    const res = await fetch("https://script.google.com/macros/s/AKfycbw9i38dvDy3B8ZSZuuidSLhws16l4fg_D6GhnmIvwOJf7wWP_YTw1Dye1mn7YGK-YYN/exec", {
      method: "POST",
    ...
    // Pending approval dulu
    lockText.innerText = "Form terkirim. Tunggu approval admin.";

    // Polling tiap 3 detik cek status approval
    const checkStatus = setInterval(async ()=>{
      const statusRes = await fetch("https://script.google.com/macros/s/AKfycbw9i38dvDy3B8ZSZuuidSLhws16l4fg_D6GhnmIvwOJf7wWP_YTw1Dye1mn7YGK-YYN/exec?entryCode=" + data.entryCode);
